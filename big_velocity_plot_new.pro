...
set_plot, 'ps'
device, filename='big_'+plot_names[j]+'.eps', /encapsul, /color, BITS=8, XSIZE=30, YSIZE=50
...
for i=0, n_elements(galaxy_names)-1 do begin
	...
	jimmy_display_bins, xbin, ybin, V, x,y, PIXELSIZE=1, RANGE=[min_scale, max_scale], XRANGE=[xmin,xmax], YRANGE=[ymin,ymax], POSITION=[leftAxisLoc, bottomAxisLoc, rightAxesLoc, topAxesLoc], CHARSIZE=2.3, CHARTHICK=7;, TITLE='Velocity'
